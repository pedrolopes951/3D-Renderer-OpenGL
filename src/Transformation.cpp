...
void Transformation::Translate(float x, float y, float z) {
    m_modelMatrix = m_projection * glm::translate(m_indentyMatrix, glm::vec3(x, y, z));
}

void  Transformation::Rotate(float angle, float x, float y, float z) {
    m_modelMatrix = m_projection * glm::rotate(m_indentyMatrix, glm::radians(angle), glm::vec3(x, y, z));
}

void  Transformation::Scale(float x, float y, float z) {
    m_modelMatrix = m_projection * glm::scale(m_indentyMatrix, glm::vec3(x, y, z));
}
